...
let productsSliderTimer = setInterval(() => move("left"), 5000);
banner.on("mouseover", () => clearInterval(productsSliderTimer));
banner.on("mouseout", () => productsSliderTimer = setInterval(() => move("left"), 5000));
