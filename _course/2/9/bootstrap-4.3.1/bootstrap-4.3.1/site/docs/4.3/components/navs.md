...
{% capture example %}
<ul class="navi_list justify-content-center">
  <li class="nav-item">
    <a class="nav-link active" href="#">Active</a>
  </li>
  <li class="nav-item">
...
{% capture example %}
<ul class="navi_list justify-content-end">
  <li class="nav-item">
    <a class="nav-link active" href="#">Active</a>
  </li>
  <li class="nav-item">
...
{% capture example %}
<ul class="navi_list flex-column">
  <li class="nav-item">
    <a class="nav-link active" href="#">Active</a>
  </li>
  <li class="nav-item">
...
{% capture example %}
<nav class="navi_list flex-column">
  <a class="nav-link active" href="#">Active</a>
  <a class="nav-link" href="#">Link</a>
  <a class="nav-link" href="#">Link</a>
  <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a>
...
{% capture example %}
<ul class="navi_list nav-pills nav-fill">
  <li class="nav-item">
    <a class="nav-link active" href="#">Active</a>
  </li>
  <li class="nav-item">
...
{% capture example %}
<nav class="navi_list nav-pills nav-fill">
...
{% capture example %}
<ul class="navi_list nav-pills nav-justified">
  <li class="nav-item">
    <a class="nav-link active" href="#">Active</a>
  </li>
  <li class="nav-item">
...
{% capture example %}
<nav class="navi_list nav-pills nav-justified">
  <a class="nav-item nav-link active" href="#">Active</a>
  <a class="nav-item nav-link" href="#">Much longer nav link</a>
  <a class="nav-item nav-link" href="#">Link</a>
  <a class="nav-item nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a>
...
{% capture example %}
<nav class="navi_list nav-pills flex-column flex-sm-row">
...
<div class="bd-example bd-example-tabs">
  <ul class="navi_list nav-tabs" id="myTab" role="tablist">
    <li class="nav-item">
...
<div class="bd-example bd-example-tabs">
  <nav>
    <div class="navi_list nav-tabs" id="nav-tab" role="tablist">
...
<div class="bd-example bd-example-tabs">
  <ul class="navi_list nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item">
...
<div class="bd-example bd-example-tabs">
  <div class="row">
    <div class="col-3">
      <div class="navi_list flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
