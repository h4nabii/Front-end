$(function () {
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    assert.expect(2)
    var tabsHTML = '<ul class="navi_list">' +
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    assert.expect(2)
    var pillsHTML = '<ul class="navi_list nav-pills">' +
        '<li><a href="#home">Home</a></li>' +
        '<li><a href="#profile">Profile</a></li>' +
        '</ul>'
  ...
  QUnit.test('should activate element by tab id in ordered list', function (assert) {
    assert.expect(2)
    var pillsHTML = '<ol class="navi_list nav-pills">' +
        '<li><a href="#home">Home</a></li>' +
        '<li><a href="#profile">Profile</a></li>' +
        '</ol>'
  ...
  QUnit.test('should activate element by tab id in nav list', function (assert) {
    assert.expect(2)
    var tabsHTML =  '<nav class="navi_list">' +
                      '<a href="#home">Home</a>' +
  ...
  QUnit.test('should not fire shown when tab is already active', function (assert) {
    assert.expect(0)
    var tabsHTML = '<ul class="navi_list nav-tabs" role="tablist">' +
  ...
  QUnit.test('show and shown events should reference correct relatedTarget', function (assert) {
    ...
    var dropHTML =
        '<ul class="drop navi_list">' +
        '  <li class="dropdown"><a data-toggle="dropdown" href="#">1</a>' +
        '    <ul class="dropdown-menu navi_list">' +
  ...
  QUnit.test('selected tab should have aria-selected', function (assert) {
    assert.expect(8)
    var tabsHTML = '<ul class="navi_list nav-tabs">' +
  ...
  QUnit.test('Nested tabs', function (assert) {
    ...
    var done = assert.async()
    var tabsHTML =
        '<nav class="navi_list nav-tabs" role="tablist">' +
  ...
  QUnit.test('should handle removed tabs', function (assert) {
    ...
    var html = [
      '<ul class="navi_list nav-tabs" role="tablist">',
      '  <li class="nav-item">',
